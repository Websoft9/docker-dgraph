...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Dgraph 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://hub.docker.com/r/dgraph/dgraph/)）：
...
如果需要企业级支持，请订阅我们提供的 [Dgraph 企业级支持版](https://apps.websoft9.com/dgraph) 
